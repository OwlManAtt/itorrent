...
$WARNING = array(
    'register_globals' => array(
                            ...
                            'help' => "Register_globals being turned on is considered bad practice. You <em>should</em> add ini_set('register_globals','Off'); to your config file after you successfully complete the installation.",
                        ),
    'display_errors' => array(
                            'value' => ini_get('display_errors'),
                            'help' => "PHP errors will not be sent to the screen - only to an error_log somewhere on your server. This may be a major inconvenience to you as your set iTorrent up. If you have problems with a blank white screen, you are probably getting PHP errors, and they are being surpressed. Add ini_set('display_errors','On'); to your config file to address this.",
                        ),
);
...
$content .= "<html>\n";
    $content .= "<head>\n";
        ...
        $content .= "<title>iTorrent System Check</title>\n";
    $content .= "</head>\n";
    $content .= "<body>\n";
        $content .= "<p>Any 'status' fields marked in <span style='color: red;'>red</span> indicate that you have a serious problem and it must be addressed for iTorrent to work. <span style='color: $yellow;'>Yellow</span> 'status' fields indicate a warning - iTorrent will work, but you probably want to take the suggested corrective action. <span style='color: green;'>Green</span> means OK. The base directory is provided here for your reference - you need it during installation.</p>\n";

        $content .= "<div align='center'>\n";
            $content .= "<table style='border: 1px solid black; border-collapse: collapse;' width='50%' border='1' cellpadding='5'>\n";
                $content .= "<tr>\n";
                    $content .= "<td colspan='2' align='center' style='font-weight: bold; font-size: large;'>iTorrent System Check</td>\n";
                $content .= "</tr>\n";
